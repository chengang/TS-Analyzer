    ...
    while(true) {
        ...
        if (tsp->unit_start_indicator) {
            ...
            if (pid_type == CGTS_PID_TYPE_PAT
                ...
                cgts_pid_buffer_append_psi_header(ct->pid_buf[pid_buffer_index], tsp->payload_ptr, tsp->payload_len);
            } else {
                cgts_pid_buffer_append_pes_header(ct->pid_buf[pid_buffer_index], tsp->payload_ptr, tsp->payload_len);
            }
        } else {
